...
class LoadResourcePresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingWithError_displaysLocalizedMessageAndStopsLoading() {
        let (sut, view) = makeSUT()
    ...
    func test_didFinishLoadingWithMapperError_displaysLocalizedMessageAndStopsLoading() {
        let (sut, view) = makeSUT(mapper: { resource in
            throw anyNSError()
        })
