//
//  EssensialFeedAPIEndToEndTests.swift
//  EssensialFeedAPIEndToEndTests
//
//  Created by Kate Zemskova on 2/22/24.
//
...
final class EssensialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedImageData_matchesFixedTestAccountData() {
